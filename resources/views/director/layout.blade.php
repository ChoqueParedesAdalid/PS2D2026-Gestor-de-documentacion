...
<head>
    ...
    <title>@yield('title', 'DocGest - Director')</title>
        ...
        <aside 
            ...
            <nav class="mt-6 px-2">
                <a href="{{ route('director.dashboard') }}" 
                   class="sidebar-link flex items-center px-4 py-3 text-white rounded-lg {{ request()->routeIs('director.dashboard') ? 'active' : '' }}">
                    <i class="fas fa-home w-6"></i><span>Inicio</span>
                </a>
                <a href="{{ route('director.materias') }}" 
                   class="sidebar-link flex items-center px-4 py-3 text-white rounded-lg {{ request()->routeIs('director.materias') ? 'active' : '' }}">
                    <i class="fas fa-book w-6"></i><span>Materias</span>
                </a>
                <a href="{{ route('director.docentes') }}" 
                   class="sidebar-link flex items-center px-4 py-3 text-white rounded-lg {{ request()->routeIs('director.docentes') ? 'active' : '' }}">
                    <i class="fas fa-chalkboard-teacher w-6"></i><span>Docentes</span>
                </a>
                <a href="{{ route('director.estudiantes') }}" 
                   class="sidebar-link flex items-center px-4 py-3 text-white rounded-lg {{ request()->routeIs('director.estudiantes') ? 'active' : '' }}">
                    <i class="fas fa-user-graduate w-6"></i><span>Estudiantes</span>
                </a>
                <a href="{{ route('director.reportes') }}" 
                   class="sidebar-link flex items-center px-4 py-3 text-white rounded-lg {{ request()->routeIs('director.reportes') ? 'active' : '' }}">
                     <i class="fas fa-chart-bar w-6"></i><span>Reportes</span>
                </a>
            </nav>
            ...
            <header class="bg-black shadow-sm border-b border-gray-800 flex-shrink-0">
                <div class="flex items-center justify-between px-6 py-4">
                    ...
                    <div class="flex items-center">
                        ...
                        <h2 class="text-xl font-semibold text-white">@yield('page-title', 'Panel de Control')</h2>
                    </div>
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open" @click.away="open = false"
                                ...
                                <div class="text-right hidden sm:block">
                                    <p class="text-sm font-medium text-white">{{ auth()->user()->nombres ?? 'Director' }}</p>
                                    <p class="text-xs text-gray-400">Director de Carrera</p>
                                </div>
