            ...
            <nav class="mt-6 px-2">
                ...
                <a href="{{ route('tutor.tutorados') }}" 
                   class="sidebar-link flex items-center px-4 py-3 text-white rounded-lg {{ request()->routeIs('tutor.tutorados') ? 'active' : '' }}">
                    <i class="fas fa-users w-6"></i><span>Tutorados</span>
                </a>
                <a href="{{ route('tutor.tareas') }}" 
                   class="sidebar-link flex items-center px-4 py-3 text-white rounded-lg {{ request()->routeIs('tutor.tareas') || request()->routeIs('tutor.tareas-ver') ? 'active' : '' }}">
